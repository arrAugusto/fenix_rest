...
public class StoredProcedures {
    ...
    public final String STORED_PROCEDURE_GET_AUTH_TRANSACTION_SIGN = "CALL GET_AUTH_TRANSACTION_SIGN(?)";//GETVALIDATOR
    ...
    //MODIFICAR ESTADO DE INGRESO
    public final String STORED_PROCEDURE_CALL_UPDATE_REVISION_ERRONEA = "CALL UPDATE_REVISION_ERRONEA(?,?,?)";
