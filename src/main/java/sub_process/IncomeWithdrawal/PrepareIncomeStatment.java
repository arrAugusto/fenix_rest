...
public class PrepareIncomeStatment {
    ...
    public PreparedStatement IncomeSQLPrepare(String query, IncomeAndWithDrawal ingreso) throws SQLException {
        ...
        preparedStatement.setString(38, isEmptyOrNull(SecureUniqueCodeGenerator.generateTransactionId()) ? null : SecureUniqueCodeGenerator.generateTransactionId());//Referencia unica generated
